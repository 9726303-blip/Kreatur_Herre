document.addEventListener("DOMContentLoaded", function () {
  ...
  function playTitleEffects() {
    ...
    for (let i = 0; i < pixels; i++) {
      ...
      s.style.setProperty("--fx", fx + "px"); s.style.setProperty("--fy", fy + "px");
      s.style.setProperty("--mx", mx + "px"); s.style.setProperty("--my", my + "px");
      s.style.setProperty("--tx", tx + "px"); s.style.setProperty("--ty", ty + "px");
      s.style.setProperty("--sz", sz + "px"); s.style.setProperty("--rot", rot + "deg");
      s.style.setProperty("--delay", delay + "ms");
      heroWrap.appendChild(s);
      s.addEventListener("animationend", () => s.remove());
    }
    if (bird) { bird.classList.remove("fly"); void bird.offsetWidth; bird.classList.add("fly"); }
  }
